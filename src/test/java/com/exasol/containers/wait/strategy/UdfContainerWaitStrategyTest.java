...
public class UdfContainerWaitStrategyTest {
    ...
    void beforeEach() {
        when(this.detectorFactoryMock.createLogPatternDetector(EXASOL_CORE_DAEMON_LOGS_PATH,
                BUCKETFS_DAEMON_LOG_FILENAME_PATTERN, UdfContainerWaitStrategy.SCRIPT_LANGUAGE_CONTAINER_READY_PATTERN))
    ...
    private WaitStrategy createWaitStrategy() {
        return new UdfContainerWaitStrategy(this.detectorFactoryMock);
    }
