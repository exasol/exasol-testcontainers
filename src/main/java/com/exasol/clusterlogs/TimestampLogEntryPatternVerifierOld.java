 ...
 */
@Deprecated
class TimestampLogEntryPatternVerifierOld implements LogEntryPatternVerifier {
    private static final Logger LOGGER = LoggerFactory.getLogger(TimestampLogEntryPatternVerifierOld.class);
    ...
    /**
     * Create a new instance of the {@link TimestampLogEntryPatternVerifierOld}.
     *
     ...
     */
    TimestampLogEntryPatternVerifierOld(final Instant afterUtc, final TimeZone timeZone) {
